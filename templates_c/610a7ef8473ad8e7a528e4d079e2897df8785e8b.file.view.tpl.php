<?php /* Smarty version Smarty-3.0.8, created on 2015-07-07 10:40:11
         compiled from "templates/default/admins/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17353650115189e70457f3e9-36765234%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '610a7ef8473ad8e7a528e4d079e2897df8785e8b' => 
    array (
      0 => 'templates/default/admins/view.tpl',
      1 => 1436214617,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17353650115189e70457f3e9-36765234',
  'function' => 
  array (
  ),
...
<form method="post" action="/magnit/admins/delete/all/">
...
<tr>
	...
	<td class="table_row_title">ФИО</td>
	<td class="table_row_title">Email</td>
	<td class="table_row_title">Группа</td>
...
"></td>
	...
	<td class="table_row_name"><?php echo $_smarty_tpl->tpl_vars['item']->value['chmod'];?>
</td>
	...
	<td class="table_row"><a href="/magnit/admins/edit/<?php echo $_smarty_tpl->tpl_vars['item']->value['group_id'];?>
...
i/edit.png" width="19" height="20" alt="Изменить"></a></td>
	<td class="table_row"><a onClick="conf('/magnit/admins/delete/<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
