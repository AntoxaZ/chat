<?php /* Smarty version Smarty-3.0.8, created on 2015-07-07 10:47:58
         compiled from "templates/default/advertising/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:83309106251932e1b208975-28310601%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9831ee1f380c0bb777c385ff2ec54b94db39fb95' => 
    array (
      0 => 'templates/default/advertising/view.tpl',
      1 => 1436214618,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '83309106251932e1b208975-28310601',
  'function' => 
  array (
  ),
...
<form method="post" action="/magnit/advertising/delete/all/">
...
<tr>
	...
	<td class="table_row_title">Название</td>
	<td class="table_row_title">Кликов</td>
	<td class="table_row_title">Url</td>
	<td class="table_row_title">Картинка</td>
...
"></td>
	...
	<td class="table_row"><?php echo $_smarty_tpl->tpl_vars['item']->value['click'];?>
</td>
	<td class="table_row_name"><a href="http://<?php echo $_smarty_tpl->tpl_vars['item']->value['url'];?>
/" target="blank"><?php echo $_smarty_tpl->tpl_vars['item']->value['url'];?>
</a></td>
	<td class="table_row"><?php if ($_smarty_tpl->tpl_vars['item']->value['text']){?><?php echo $_smarty_tpl->tpl_vars['item']->value['text'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['item']->value['image'];?>
<?php }?></td>
	...
	<td class="table_row"><a href="/magnit/advertising/edit/<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
...
i/edit.png" width="19" height="20" alt="Изменить"></a></td>
	<td class="table_row"><a onClick="conf('/magnit/advertising/delete/<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
